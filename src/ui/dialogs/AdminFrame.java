...
public class AdminFrame extends javax.swing.JFrame implements DialogWithCatalogInterface{
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(ui.dialogs.TrabalhoES1App.class).getContext().getResourceMap(AdminFrame.class);
        ...
        codesTable.setName("codesTable"); // NOI18N
        codesTable.setRowHeight(25);
        codesTable.getTableHeader().setReorderingAllowed(false);
        jScrollPane3.setViewportView(codesTable);
    ...
    public javax.swing.JTable getCodesTable() {
        return codesTable;
    }
